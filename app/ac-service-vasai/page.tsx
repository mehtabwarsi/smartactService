...
export const metadata: Metadata = {
  ...
  description: 'Professional AC service in Vasai. Get same-day AC repair, installation, and gas refilling from expert technicians. Honest pricing, 100% satisfaction guaranteed.',
  keywords: 'AC Service Vasai, AC Repair Vasai, AC Gas Filling Vasai, AC Installation Vasai, Best AC Repair Near Me',
  alternates: { canonical: 'https://smartacservice.in/ac-service-vasai' },
  openGraph: {
    title: 'AC Service Vasai | Fast AC Repair & Gas Filling',
    description: 'Professional AC service in Vasai. Get same-day AC repair, installation, and gas refilling from expert technicians. Honest pricing, 100% satisfaction guaranteed.',
    url: 'https://smartacservice.in/ac-service-vasai',
...
export default function Page() {
  const seoContent = (
    ...
    <div className="seo-article">
      ...
      <h3>Our Specialised AC Services in Vasai</h3>
      ...
      <p>Is your AC making strange rattling noises? Is water leaking from the indoor unit? Or perhaps it is simply blowing warm air? Our diagnostic process is thorough and precise. We do not just treat the symptoms; we identify and eliminate the root cause of the problem. From replacing faulty capacitors and repairing malfunctioning printed circuit boards (PCBs) to fixing frozen evaporator coils, our <strong>AC repair in Vasai</strong> covers every possible issue. We carry genuine OEM replacement parts, ensuring that every repair is durable and restores your unit to its original factory performance.</p>
      ...
      <h3>Common AC Problems We Fix Daily in Vasai</h3>
      ...
      <h3>Book Your AC Service in Vasai Today</h3>
      <p>Do not let a malfunctioning air conditioner ruin your comfort. Whether you need an emergency repair, a routine seasonal service, or a flawless new installation, we are here to help. Join the thousands of satisfied customers who have made us their go-to choice for all their cooling needs. Experience the difference of premium, hassle-free AC care. Contact us today via phone, WhatsApp, or our online booking form, and let our experts restore perfect, icy-cold comfort to your home in <strong>Vasai</strong>.</p>
    </div>
  ...
  const overrideH1 = (
    <>
      Premium AC Service & Repair<br />
      <span className="text-grad-brand">in Vasai</span>
    </>
  );
  ...
  return (
    <>
      ...
      <ClientPage 
        ...
        overrideHeroText="Experience the best AC service in Vasai. We specialize in split and window AC repair, deep cleaning, and installation across Vasai Road and surrounding areas."
      />
    </>
  );
}
