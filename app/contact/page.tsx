...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with Smart AC Service for urgent AC repair, installation, or gas filling. Call us or book online for same-day service in Nalasopara, Vasai, Virar & Mumbai.',
  keywords: 'Contact Smart AC Service, Book AC Repair, AC Service Phone Number',
  alternates: { canonical: 'https://smartact-service.vercel.app/contact' },
  openGraph: {
    title: 'Contact Smart AC Service | Book Your AC Repair',
    description: 'Get in touch with Smart AC Service for urgent AC repair, installation, or gas filling. Call us or book online for same-day service in Nalasopara, Vasai, Virar & Mumbai.',
    url: 'https://smartact-service.vercel.app/contact',
...
export default function Page() {
  ...
  const overrideH1 = (
    <>
      Contact Our AC<br />
      <span className="text-grad-brand">Experts Today</span>
    </>
  );
  ...
  return (
    <>
      ...
      <ClientPage
        ...
        overrideHeroText="Need urgent cooling solutions? Our team is standing by. Reach out via phone, WhatsApp, or our online form for immediate assistance."
      />
    </>
  );
}
