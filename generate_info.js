...
const infoPages = [
  {
    ...
    desc: 'Learn about Smart AC Service. We are a team of certified technicians dedicated to providing premium AC repair and installation across Mumbai and surrounding areas.',
    keywords: 'About Smart AC Service, AC Repair Experts, Certified AC Technicians',
    h1: 'About Smart AC Service',
    heroDesc: 'Discover the story behind Smart AC Service. We are driven by a singular mission: to provide the most reliable, transparent, and high-quality AC service in the region.'
  },
  {
    path: 'contact',
    title: 'Contact Smart AC Service | Book Your AC Repair',
    desc: 'Get in touch with Smart AC Service for urgent AC repair, installation, or gas filling. Call us or book online for same-day service in Nalasopara, Vasai, Virar & Mumbai.',
    keywords: 'Contact Smart AC Service, Book AC Repair, AC Service Phone Number',
    h1: 'Contact Our AC Experts Today',
    heroDesc: 'Need urgent cooling solutions? Our team is standing by. Reach out via phone, WhatsApp, or our online form for immediate assistance.'
  },
  {
    path: 'privacy-policy',
    title: 'Privacy Policy | Smart AC Service',
    desc: 'Read the Privacy Policy of Smart AC Service. Learn how we protect your personal information and ensure a secure experience when you book our services.',
    keywords: 'Privacy Policy, Smart AC Service Privacy, Data Protection',
    h1: 'Our Privacy Policy',
    heroDesc: 'We value your trust and are committed to protecting your privacy. Read our comprehensive policy detailing how we handle and safeguard your personal information.'
  },
  {
    path: 'terms-and-conditions',
    title: 'Terms and Conditions | Smart AC Service',
    desc: 'Review the terms and conditions for booking AC repair and installation with Smart AC Service. Transparent policies for a hassle-free experience.',
    keywords: 'Terms and Conditions, Smart AC Service Terms, Service Policies',
    h1: 'Terms and Conditions of Service',
    heroDesc: 'Clear, transparent, and fair. Please review our terms and conditions to understand our service policies, warranties, and commitment to you.'
  }
];
...
infoPages.forEach(page => {
  const dir = path.join(root, 'app', page.path);
...
export default function Page() {
  ...
  const overrideH1 = (
    <>
      ${page.h1.split(' ').slice(0, -2).join(' ')}<br />
      <span className="text-grad-brand">${page.h1.split(' ').slice(-2).join(' ')}</span>
    </>
  );
  ...
  return (
    <>
      ...
      <ClientPage 
        ...
        overrideHeroText="${page.heroDesc}"
      />
    </>
  );
}
...
console.log('Info pages generated');
