...
/* ────────────────────────────────────────────────
   MAIN PAGE
──────────────────────────────────────────────── */
export default function ClientPage({ seoContent, overrideH1, overrideHeroText }: { seoContent?: React.ReactNode, overrideH1?: React.ReactNode, overrideHeroText?: React.ReactNode }) {
    ...
    return (
      <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center mesh-dark">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="text-center">
          ...
          <p className="text-sm font-medium !text-white/80 mb-8">Loading premium experience…</p>
        </motion.div>
              ...
              <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <h2 className="font-display mt-2 text-xl font-extrabold sm:text-2xl !text-white">
                      Free Inspection on All AC Repair Bookings
                    </h2>
                    <p style={{ color: '#ffffff' }} className="mt-1 text-sm !text-white-400">Save ₹200 on your first visit. Valid for Nalasopara, Vasai &amp; Virar. Limited slots daily.</p>
                  </div>
                </div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={vStagger}>
              <motion.div variants={vFadeUp} className="mb-14 grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-end">
                ...
                <p className="text-lg !text-white/60 leading-relaxed lg:mb-2">
                ...
                {whyUs.map((item, i) => {
                  ...
                  return (
                    <motion.div key={item.title} variants={vFadeUp} whileHover={{ y: -4, scale: 1.01 }} transition={{ duration: 0.2 }}
                      ...
                      <p className="mt-2 text-[13px] leading-relaxed !text-white/80">{item.desc}</p>
                    </motion.div>
                  );
                })}
              </motion.div>
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={vStagger}>
              <motion.div variants={vFadeUp} className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between mb-14">
                ...
                <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 px-5 py-3 backdrop-blur shrink-0">
                  ...
                  <div>
                    <p className="text-[13px] font-semibold !text-white/80">Google Rating</p>
                    <p className="text-[12px] !text-white/70">1,000+ reviews</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div variants={vStagger} className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                {reviews.map((r) => (
                  <motion.div key={r.name} variants={vFadeUp} whileHover={{ y: -5 }} transition={{ duration: 0.2 }}
                    ...
                    <p className="text-[14px] leading-relaxed !text-white flex-1">&ldquo;{r.text}&rdquo;</p>
                    ...
                    <div className="mt-5 flex items-center gap-3 pt-4 border-t border-white/8">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] !text-white/70">{r.loc} · {r.date}</p>
                      </div>
                      <div className="ml-auto text-[10px] font-semibold !text-white/70 bg-white/5 px-2 py-1 rounded-full">Google</div>
                    </div>
                  </motion.div>
                ))}
              </motion.div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={vStagger} className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
              ...
              <motion.div variants={vSlideL}>
                ...
                <p className="mt-5 text-[17px] !text-white/80 leading-relaxed">
                ...
                <div className="mt-6 flex items-start gap-3 rounded-2xl border border-[#22C55E]/15 bg-[#22C55E]/6 px-4 py-4">
                  ...
                  <p className="text-[13px] text-slate-400">
                    <strong className="!text-white font-semibold">No upfront payment required.</strong> <p className="text-[13px] !text-white/80"> We quote before we start and bill only after the work is done to your satisfaction.</p>
                  </p>
                </div>
              </motion.div>
              ...
              <motion.div variants={vSlideR}>
                <div className="rounded-[28px] border border-white/10 bg-white/5 backdrop-blur-sm p-6 sm:p-8" style={{ boxShadow: "0 32px 80px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.06)" }}>
                  ...
                  <p className="mt-1 text-[14px] !text-white/80">We&apos;ll confirm within 30 minutes and schedule at your convenience.</p>
      ...
      <footer className="border-t border-white/5 bg-[#05080f] text-slate-500">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold tracking-widest !text-white/80">PREMIUM AC CARE</p>
                </div>
              </div>
              <p className="mt-4 text-[14px] !text-white/80 leading-relaxed">
            ...
            {/* Quick Links */}
            <div>
              <p className="text-[11px] font-bold uppercase tracking-widest !text-white/80 mb-4">Quick Links</p>
              <ul className="space-y-2.5 text-[14px]">
                {[["Home", "#home"], ["Services", "#services"], ["Pricing", "#pricing"], ["About", "#about"], ["FAQ", "#faq"], ["Contact", "#contact"]].map(([l, h]) => (
                  <li key={l}><a href={h} className="hover:!text-white  !text-white/80 transition-colors duration-150">{l}</a></li>
                ))}
              </ul>
            </div>
            ...
            {/* Services */}
            <div>
              <p className="text-[11px] font-bold uppercase tracking-widest !text-white/80 mb-4">Services</p>
              <ul className="space-y-2.5 text-[14px]">
                {services.slice(0, 7).map(s => (
                  <li key={s.title}><a href="#services" className="hover:!text-white !text-white/80 transition-colors duration-150">{s.title}</a></li>
                ))}
              </ul>
            </div>
            ...
            {/* Areas + Contact */}
            <div>
              <p className="text-[11px] font-bold uppercase tracking-widest !text-white/80 mb-4">Service Areas</p>
              ...
              <p className="text-[11px] font-bold uppercase tracking-widest !text-white/80 mb-3">Contact</p>
              <ul className="space-y-2 text-[14px]">
                <li><a href={`tel:${PHONE}`} className="hover:!text-white !text-white/80 transition-colors">{PHONE_DISPLAY}</a></li>
                <li><a href={`mailto:${EMAIL}`} className="hover:!text-white !text-white/80 transition-colors break-all">{EMAIL}</a></li>
                <li><a href={WHATSAPP} target="_blank" rel="noreferrer" className="hover:text-[#22C55E] !text-white/80 transition-colors">WhatsApp Support</a></li>
              </ul>
            </div>
          </div>

          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-6 sm:flex-row">
            <p className="text-[13px] !text-white/80">© 2026 Smart AC Service. All rights reserved.</p>
